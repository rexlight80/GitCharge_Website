...
const TuneSubscription = () => {
  return (
    ...
    Change the payment method that user's use to pay for future subscription renewals and charges. It's especially important where subscriptions are past due, meaning customers have an outstanding payment.
    </span> 
    <TuneSubBtn/>
    </div>
    )
